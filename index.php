...
<div id="container">
    <div id="CVContainer">
        ...
        <header>
            <div id="Entry">
                <h1>Kermit's CV</h1>
                <div id="photo_citation">
                    <img src="kermit.jpg" alt="Working_Kermit">
                    <p>
                        <a href="https://www.youtube.com/watch?v=WS3Lkc6Gzlk">"Why are there so many songs about rainbows"</a>
                    </p>
                </div>
            </div>
        </header>
        ...
        <footer>
            ...
            <form>
                <fieldset>
                    ...
                    <input type="text" id="name" name="monster">
                    <label for="name">Name</label><br/>

                    <input type="email" id="email" name="monster">
